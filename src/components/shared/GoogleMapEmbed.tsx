...
/* ============================================
   ...
   platino/plata theme (cool neutral, aplicado vía CSS filter)
   ============================================ */
...
export default function GoogleMapEmbed({
  ...
  // Google Maps embed URL (el tema platino/plata se aplica con CSS filter, no vía estilos pb)
  ...
  return (
    ...
    >
      ...
      {!isLoaded && (
        <div className="absolute inset-0 bg-champagne/30 flex items-center justify-center z-10">
          <div className="text-center">
            <div className="w-12 h-12 border-4 border-silver/30 border-t-silver rounded-full animate-spin mx-auto mb-4" />
      ...
      <iframe
        ...
        style={{ filter: "saturate(62%) brightness(105%) contrast(95%)" }}
        loading="lazy"
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-full -mt-4 pointer-events-none">
        ...
        <div className="w-3 h-3 bg-silver rounded-full mx-auto -mt-1 shadow-md" />
      </div>
    </div>
  );
}
