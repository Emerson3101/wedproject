...
export const metadata: Metadata = {
  ...
  description:
    "¡Estás invitado a celebrar nuestro gran día! Descubre todos los detalles de la boda de Emerson y Plancarte el 18 de Octubre, 2025.",
  keywords: [
    "boda",
    "invitación",
    "matrimonio",
  ...
  openGraph: {
    ...
    description:
      "Únete a nosotros para celebrar nuestro amor. 18 de Octubre, 2025.",
    url: "/",
  },
  twitter: {
  ...
  other: {
    ...
    "application/ld+json": JSON.stringify({
      ...
      eventType: "Wedding",
      startDate: "2025-10-18T16:00:00-06:00",
      endDate: "2025-10-18T23:59:00-06:00",
